...
def _make_settings_page(config: AppConfig):
    ...
    vm = SimpleNamespace(
        ...
        get_db_stats=lambda: SimpleNamespace(file_size=0, record_count=0, hidden_count=0, domain_count=0),
        _main_vm=SimpleNamespace(
