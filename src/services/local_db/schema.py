...
class _SchemaMixin:
    ...
    def _init_schema_on_conn(self, conn: sqlite3.Connection) -> None:
        ...
        conn.executescript("""
                ...
                CREATE INDEX IF NOT EXISTS idx_bookmarks_host ON bookmarks(host);
                -- Composite index for keyset pagination ORDER BY bookmarked_at DESC, id DESC.
                CREATE INDEX IF NOT EXISTS idx_bookmarks_at_id
                    ON bookmarks(bookmarked_at DESC, id DESC);
