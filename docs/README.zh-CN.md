...
## 🤝 贡献
欢迎任何形式的贡献。请先阅读 [CONTRIBUTING.md](../CONTRIBUTING.md) 了解开发环境、代码规范和 DCO 签署要求。提交 Bug、功能建议或使用问题时，请优先使用 GitHub 提供的 issue 模板。
...
## 📞 联系
- 作者：骰子掷上帝 (TheSkyC)
- 支持：support@historysync.app
- 安全：security@historysync.app