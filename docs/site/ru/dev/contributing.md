...
Сообщайте в частном порядке по электронной почте **security@historysync.app**. Включите описание, шаги воспроизведения и возможное воздействие. Вы получите ответ в течение 72 часов.
